...
public class EditAnyProductActivity extends AppCompatActivity {
    private ImageButton backBtn;
    private ImageView productIconIv;
    private EditText titleEt,descriptionEt;
    private TextView categoryTv, quantityTv, priceTv,discountedPriceTv,discountedNoteTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_any_product);
        ...
        discountedPriceTv = findViewById(R.id.etDiscountedPrice);
        ...
        updateProductBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //input data
                //validate data
        ...
        reference.child(firebaseAuth.getUid()).child("Products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                        ...
                        String discountedPrice = ""+datasnapshot.child("discountedPrice").getValue();
    ...
    private void inputData() {
        ...
        if (discountAvailable){
            discountedPrice =discountedPriceTv.getText().toString().trim();
            ...
            reference.child(firebaseAuth.getUid()).child("Products").child(productId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(EditAnyProductActivity.this, "Updated.", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(EditAnyProductActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
